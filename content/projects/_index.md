...
1. **Track progress**: Record ongoing work, ideas, and experiments to prevent them from languishing unfinished.
2. **Teach by example**: Show the steps, challenges, and insights gained so others can learn without starting from scratch.
3. **Bridge private and public work**: Present private analytical projects while also sharing open-source experiments, striking a balance between personal exploration and contribution to the wider community.
